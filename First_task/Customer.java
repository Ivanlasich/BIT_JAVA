...
public class Customer {
    ...
    /**
     * Opens account for a customer (creates DebitCard and sets it to field "account").
    ...
    /**
     * Delegates withdraw to DebitCard class
     *
     * @param amount
     * @return false if account is null and prints "Customer fullName() has no active account", otherwise returns the result of DebitCard's withdraw method
     */
    ...
    /**
     * Delegates adding money to DebitCard class
     *
     * @param amount
     * @return false if account is null and prints "Customer fullName() has no active account", otherwise returns the result of DebitCard's add method
     */
