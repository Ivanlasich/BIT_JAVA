...
public class TransactionManager {
    ...
    public Transaction createTransaction(double amount,
        ...
        HashMap<Account, Integer> mostFrequent = originator.getMostFrequent();
    ...
    public Collection<Transaction> findAllTransactionsByAccount(Account account) {
        ...
        Transaction higher = list.lower(new Transaction(-1,0, new DebitCard(account.getId()+1, null),null,false,false));
